package com.kodyhusky.examplemod.armor;
...
public enum ModArmorMaterial implements IArmorMaterial {
    ...
    RUBY(ExampleMod.MOD_ID + ":ruby", 25, new int[] { 2, 5, 6, 2 }, 18,
            SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 0.0F, () -> { return Ingredient.fromItems(RegistryHandler.RUBY.get());}, 0.0F);
